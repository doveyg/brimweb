...
$bConn = odbc_connect('DRIVER={SQL Server};Server=INSQL2;Database=' . $_GET['dbname'] . ';', 'sa', 'woznium');
$rConn = odbc_connect('DRIVER={SQL Server};Server=INSQL2;Database=runtime;', 'sa', 'woznium');
$chartCount = 0;
$units = array();
